    ...
    >
      <div className="max-w-[590px] w-full mb-20 md:mb-10">
        ...
        <div className="w-full max-w-[290px] mt-4 relative group/cta">
          ...
          <button className="relative rounded-[11px] max-w-[290px] w-full bg-w-cream-light py-4 text-xl active:bg-w-cream   group-hover/cta:-translate-x-2 group-hover/cta:-translate-y-2 transition-transform ease-out">
            <span>להרשמה</span>
          </button>
        </div>
      </div>
