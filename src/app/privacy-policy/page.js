...
export default function page() {
  return (
    <main className="flex mx-auto min-h-screen flex-col items-center max-w-screen-2xl px-4 whitespace-break-spaces">
      <Header></Header>
      <h1 className="underline text-center text-2xl">מדיניות פרטיות</h1>
      <div dir="rtl" className="max-w-[720px]">
        {`
א. הקדמה
